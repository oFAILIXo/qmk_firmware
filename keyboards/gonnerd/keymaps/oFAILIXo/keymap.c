...
[BASE_LAYER] = KEYMAP_60(
    ...
    OSL(1),        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,           KC_QUOT,                    KC_ENT,\
...
KC_TRNS,KC_LEFT,KC_DOWN,KC_RGHT,KC_TRNS,KC_TRNS,KC_HOME,KC_LEFT,KC_DOWN,KC_RIGHT,KC_DEL, KC_INS, KC_TRNS,\
...
[SPACE_LAYER] = KEYMAP_60( 
    ...
    KC_CAPS,	KC_BSPC,	KC_LEFT,	KC_DOWN,	KC_RGHT,	LCTL(KC_BSPC),	LCTL(KC_DEL),	KC_MS_L,	KC_MS_D,	KC_MS_R,	KC_DEL, 	KC_TRNS,			KC_TRNS,\
    KC_TRNS,	__x__,		KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,	KC_TRNS,\
