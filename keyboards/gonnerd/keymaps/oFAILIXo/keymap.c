...
OSL(1),        KC_A,    KC_S,    KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L,    KC_SCLN, KC_QUOT,               KC_GRV, KC_ENT,\
OSM(MOD_LSFT),          KC_Z,    KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_LSFT,KC_RALT), TO(2), \
OSM(MOD_LCTL), KC_LGUI, OSM(MOD_LALT),             LT(4, KC_SPC),             KC_RALT, KC_MENU, MO(3),                KC_DEL),
...
KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_DEL,  KC_INS,           KC_TRNS, KC_TRNS,\
KC_TRNS,          KC_TRNS, KC_DEL,  KC_TRNS, KC_TRNS, KC_TRNS, KC_END,  KC_MUTE, KC_VOLD, KC_VOLU,  KC_TRNS,          KC_TRNS, KC_TRNS,\
...
KC_CAPS, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, LCTL(KC_BSPC), LCTL(KC_DEL), KC_MS_L, KC_MS_D, KC_MS_R, KC_DEL,  KC_TRNS,		KC_TRNS, KC_TRNS,\
KC_TRNS,	  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,	    KC_TRNS,	  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS,\
